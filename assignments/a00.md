...
```
The import thing here is `a00` which indicates that you are currently in the a00 folder.
...
Next, lets add some html. Right click on the a00 folder, select "New File," and name the new file `index.html`.

Copy and paste the following code into the new file `index.html`:
```html
<!DOCTYPE html>  
<html lang="en">  
<head>  
