...
Welcome to COMP 426 - *Modern Web Programming*. The purpose of this is assignment is to get familiar with the tools that we will be using for the rest of the semester as well as the assignment submission process.
