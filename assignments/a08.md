...
When you run Browsersync in the a08 assignment directory, you should see a basic Axios testing app. For the remainder of this assignment, you can use this app to write and test Axios requests. Let's try making a basic HTTP request right now.
...
5. If successful, you should see the server respond with the hero data we used in a04 and a05. The text will appear as JSON in green in the Axios testing app.
