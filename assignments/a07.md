...
1. Include an `index.html` file with your submission that loads the 2048 user interface and allows the game to be played. This is what the LAs will use to play your game when they hand-grade your assignment. We will only be using the `view your submission` button this website. If the game does not load from that button you're assignment will not be graded.
