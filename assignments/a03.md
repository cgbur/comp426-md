...
All of the starting files where you will place your code have been provided for you inside the a03 folder. If you wish to separate your code into seperate files or make helper functions feel free to do so but it should not be necessary. 
