...
1. To get started, open Visual Studio Code and take a look at the a02 assignment directory. **Please pull the latest changes from github before starting, tweeks to the assignment starter code may have been made after the start of the semester**.
