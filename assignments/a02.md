...
For this assignment, your task is to correctly add Bulma classes to the HTML document with the goal of improving the visual appeal. You are required to copy the style exactly. To make this easier we are providing a list of the classes that were used to style the page. We have also gone ahead and left some of the classes in the html file. This is to give you an idea of the structure we used when designing our pages. 

Below is a link to the Bulma documentation. When you use any CSS framework you aren't familiar with, the docs are going to be your best friend. In the table we list out sections where you might find the classes used and get a better understanding of how Bulma works. We recommend skimming the documentation to make yourself familiar with it beforehand.

> Some Visual Studio Code users may find it helpful to get an extension that autocompletes classes for you. This can be especially useful when working with an unfamiliar framework. If you use Webstorm this functionality is built in.

**[Bulma Documentation](https://bulma.io/documentation/)**

### 4.1 Website Screenshots

Here are screenshots of the website that you are trying to create. Remember, because you are using a CSS framework, you don't have to worry about making things mobile friendly or adjusting to every browser size. Instead, by using the styles in the next section, your website should automatically be able to match these images. 
