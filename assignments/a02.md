...
For this assignment, your task is to correctly add Bulma classes to the HTML documents with the goal of improving their visual appeal. You have a lot of freedom to make the pages as pretty as you wish, but at a minimum you must meet to the following requirements:
