...
For this assignment, your task is to correctly add Bulma classes to the HTML document with the goal of improving the visual appeal. You are required to copy the style exactly. To make this easier we are providing a list of the classes that were used to style the page. 
